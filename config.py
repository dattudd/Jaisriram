...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Noobxcoders/UpdateJessy")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/NaughtyXoxo")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/aliciaNetwork")
...
START_VID_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/a729a7169c1593ec56bed.mp4")
...
if START_VID_URL:
    if START_VID_URL != "assets/Ping.mp4":
